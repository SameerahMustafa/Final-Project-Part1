...
#Import required libraries list
import sys
import datetime
...
if __name__ == "__main__":
    ...
    #lists and dictionary to hold data
    existing_majors = []
    student_objects = []
    students_dictionary = {}

    #Reading data from csv files by calling output function
    students_data, gpa_data, graduation_date_data = read_all_inputs(students_data_filename, gpa_filename,
                                                                    graduation_date_filename)
